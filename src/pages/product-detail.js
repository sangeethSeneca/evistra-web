...
function ProductDetailPage() {
  ...
  const { _id, price, image, modelName, Description, Color, Brandname, BikeType, WheelSize, FrameMaterial, SuspensionType, SpecialFeature, IncludedComponents } = router.query;
  const product = {
    image: "images/1.jpg",
    brand: "NCC",
    name: "E-Bike 200",
